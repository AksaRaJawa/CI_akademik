...
<html>
  <head>
    <title>SI AKADEMIK VERSION 0.1</title>
...
<nav class="navbar navbar-default" role="navigation">
          ...
          <div class="col-md-5">
              ...
              <tr><td>Username</td><td>
                      <div class="input-group">
                          <input type="text" name="username" placeholder="Username ..." autofocus="" class="form-control" required>
  ...
  <span class="input-group-addon"><i class="fa fa-keyboard-o"></i></span>
              ...
              <tr><td></td><Td><?php echo $image;?>
                      <div class="col-md-8">
                          <input type="text" name="kode_aman" placeholder="Masukan Kode Keamanan"  class="form-control" required></div>
                  </td></tr>
              <tr><td></td><td> </td></tr>
      ...
      <hr>
      <p align="center">SISTEM INFORMASI AKADEMIK VERSION 0.1 | MANUAL BOOK</p>
